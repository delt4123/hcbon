...
//
$mail_sys = "hello@hcbon.co.jp";	// 管理者のメールアドレス
$from_name = "株式会社 H C’ Bon";	// メール送信者の表示
$from_mail = "hello@hcbon.co.jp";	// メール送信者のメールアドレス（返信先）
...
宮城県仙台市青葉区中央１丁目２−３
仙台マークワン 19F
https://www.hcbon.co.jp/index.html
------------
";
//------------------------------------------------
...
//
$form_input = array(
	"item1" => array("title" => "名前", "name" => "item1", "func" => "2", "require" => "1", "check" => "1",),
	"item2" => array("title" => "テスト１", "name" => "item2", "func" => "2", "require" => "1", "check" => "1",),
	"item3" => array("title" => "テスト２", "name" => "item3", "func" => "7", "require" => "1", "check" => "1",),
	"item4" => array("title" => "テスト３", "name" => "item4", "func" => "7", "require" => "", "check" => "1",),
	"item5" => array("title" => "テスト４", "name" => "item5", "func" => "7", "require" => "", "check" => "1",),
	"item6" => array("title" => "てすと５", "name" => "item6", "func" => "7", "require" => "", "check" => "1",),
	"item7" => array("title" => "テスト６", "name" => "item7", "func" => "7", "require" => "", "check" => "1",),
	"item8" => array("title" => "テスト７", "name" => "item8", "func" => "7", "require" => "", "check" => "1",),
